...
namespace Week_1
{
    class Program
    {
            ...
            while (true)
            {
                ...
                switch (keyInfo.KeyChar)
                {
                    ...
                    case '4':
                        ...
                        {
                            Console.WriteLine("Regex syntax is invalid.");
                        }
                        break;
                    case '5':
                        ConstructDfa();
        ...
        private static void ConstructDfa()
        {
            ...
            if (toUse != null)
            {
                ...
                if (hopcroftDfa.States.Count > 25)
                {
                    ...
                    Console.WriteLine(
                        "Due to char(ASCII) limitations, parsing issues could arise with printing this dfa correctly to an image");
                    Console.WriteLine(
                        "The above shown list of transitions from this hopcroft dfa ARE STILL CORRECT however");
                }
            }
            else
            {
        ...
        private static void Execute(RegExp regExp)
        {
